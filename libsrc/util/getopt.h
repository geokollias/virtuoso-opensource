 ...
 *  risking name clashes with other libraries
 */
#define _getopt_internal	OPL__getopt_internal
#define getopt			OPL_getopt
#define getopt_long		OPL_getopt_long
#define getopt_long_only	OPL_getopt_long_only
#define optarg			OPL_optarg
#define opterr			OPL_opterr
#define optind			OPL_optind
#define optopt			OPL_optopt
#endif /* NO_NAMESPACES */
...
GLOBALREF int optind;

/* Callers store zero here to inhibit the error message `getopt' prints
   for unrecognized options.  */

GLOBALREF int opterr;

/* Set to an option character which was unrecognized.  */

GLOBALREF int optopt;
