...
typedef void (*bif_type_func_t) (state_slot_t ** args, long *dtp, long *prec, long *scale, caddr_t * collation);
...
caddr_t bif_string_or_null_arg (caddr_t * qst, state_slot_t ** args, int nth, const char *func);
caddr_t bif_string_or_wide_or_null_arg (caddr_t * qst, state_slot_t ** args, int nth, const char *func);
...
caddr_t row_str_column (caddr_t * qst, db_buf_t str, char *tb_name, char *col_name, int *exists);
...
BEGIN_CPLUSPLUS extern int _thread_sched_preempt;
...
caddr_t box_narrow_string_as_utf8 (caddr_t _str, caddr_t narrow, long max_len, caddr_t _charset);
caddr_t box_wide_as_utf8_char (caddr_t _wide, long wide_len, dtp_t dtp);
caddr_t box_utf8_string_as_narrow (ccaddr_t _str, caddr_t narrow, long max_len, caddr_t _charset);
extern caddr_t box_utf8_as_wide_char (ccaddr_t _utf8, caddr_t _wide_dest, long utf8_len, long max_wide_len);
caddr_t box_wide_char_string (caddr_t data, size_t len);
caddr_t box_varchar_string (db_buf_t place, int len, dtp_t dtp);
caddr_t box_cast_to (caddr_t * qst, caddr_t data, dtp_t data_dtp, dtp_t to_dtp, ptrlong prec, ptrlong scale, caddr_t * err_ret);
void dt_to_parts (char *dt, int *year, int *month, int *day, int *hour, int *minute, int *second, int *fraction);
...
typedef enum
{ DKST_IDLE = 0, DKST_RUN, DKST_FINISH, DKST_BURST } dks_thread_state_t;
