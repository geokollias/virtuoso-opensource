...
void tb_write_misc (dbe_column_t ** cols, dk_session_t * ses, db_buf_t old_misc, dbe_table_t * tb, caddr_t * qst,
    state_slot_t ** slots);
...
void ins_misc_col (dk_session_t * ses, dbe_table_t * tb, oid_t * col_ids, caddr_t * values);
