...
const char *xper_elements_vtb_feed (xper_entity_t * xpe, vt_batch_t * vtb, lh_word_callback_t * cbk, lang_handler_t * lh,
    caddr_t * textbufptr);
void xper_blob_vtb_feed (query_instance_t * qi, blob_handle_t * xper_blob, vt_batch_t * vtb, lh_word_callback_t * cbk,
    lang_handler_t * lh, caddr_t * textbufptr);
void xper_str_vtb_feed (query_instance_t * qi, caddr_t xper_str, vt_batch_t * vtb, lh_word_callback_t * cbk, lang_handler_t * lh,
    caddr_t * textbufptr);
...
xper_entity_t *DBG_NAME (xper_entity) (DBG_PARAMS query_instance_t * qi, caddr_t source_arg, caddr_t vt_batch, int is_html,
    caddr_t path, caddr_t enc_name, lang_handler_t * lh, caddr_t dtd_config, int index_attrs);
