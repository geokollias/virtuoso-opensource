...
extern caddr_t xml_view_name (client_connection_t * cli, char *q, char *o, char *n, char **err_ret, caddr_t * q_ret,
    caddr_t * o_ret, caddr_t * n_ret);
...
\c xpp may be NULL if allow_xp_error is 0.
*/
extern caddr_t *xp_word_or_phrase_from_string (xpp_t * xpp, char *str, encoding_handler_t * eh, lang_handler_t * lh,
    int allow_xp_error);
extern caddr_t *xp_text_parse (char *str, encoding_handler_t * eh, lang_handler_t * lh, caddr_t * ret_dtd_config,
    caddr_t * err_ret);
