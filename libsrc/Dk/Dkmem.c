...
#  define ENABLE_GCC_OPTS		1

# if (defined(__i386__) || defined(__x86_64__))
#  define HAVE_BUILTIN_IA32_STOREUPS	1
#  define HAVE_BUILTIN_IA32_LOADUPS	1
#  define HAVE_BUILTIN_IA32_MOVNTPS	1
# endif

# if defined(__clang__) && defined (__APPLE__)
#  undef HAVE_BUILTIN_IA32_LOADUPS			/* not all versions of clang compiler have this extension */
# endif
...
{
#if defined(HAVE_BUILTIN_IA32_STOREUPS)
  unsigned int i;
  union
  {
    v4sf_t v4;
...
{
  unsigned int inx = 0;
#if defined(HAVE_BUILTIN_IA32_MOVNTPS)
  if (len > 4)
    {
      union
      {
...
{
#if defined(HAVE_BUILTIN_IA32_STOREUPS) && defined(HAVE_BUILTIN_IA32_LOADUPS)
