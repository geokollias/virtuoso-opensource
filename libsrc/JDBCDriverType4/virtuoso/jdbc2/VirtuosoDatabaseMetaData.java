 ...
 * @see virtuoso.jdbc2.VirtuosoResultSet
 */
public class VirtuosoDatabaseMetaData implements DatabaseMetaData
{
   ...
   */
   ...
   {
      return new String(virtuoso.jdbc2.Driver.major + "." + virtuoso.jdbc2.Driver.minor + " (for Java 2 platform)");
   }
   ...
   {
      return virtuoso.jdbc2.Driver.major;
   }
   ...
   {
      return virtuoso.jdbc2.Driver.minor;
   }
