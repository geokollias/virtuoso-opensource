...
/* Note from rfc1521.html (MIME)
   ...
   <INPUT TYPE=HIDDEN NAME="LUMIK��RME&#34;Lismake&LT;=&GT;kima&#59;ra&AMP;lahna" VALUE="Suikkaboksi ��li�m�isesti huikkaa!">
   <INPUT TYPE=CHECKBOX NAME="sikaniska-NAME=lumiukko filename=pena" VALUE=RASTITTU>

   like these:
   Content-Disposition: form-data; name="LUMIK��RME"Lismake<=>kima;ra&lahna"
