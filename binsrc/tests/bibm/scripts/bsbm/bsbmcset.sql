...
cset_iri_pattern ('product', 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromProducer%%/Product%%', vector (vector (0,0), vector (0, 100000000000)));
...
cset_iri_pattern ('review', 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromRatingSite%%/Review%%', vector (vector (0,0), vector (0, 100000000000)));
...
cset_iri_pattern ('offer', 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromVendor%%/Offer%%', vector (vector (0, 0), vector (0, 200000000000)));
...
cset_iri_pattern ('person', 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromRatingSite%%/Reviewer%%', vector (vector (0, 0), vector (0, 1000000000)));
...
cset_iri_pattern ('vendor', 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromVendor%%/Vendor%%', vector (vector (0, 0), vector (0, 1000000000)));
...
cset_iri_pattern ('producer', 'http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromProducer%%/Producer%%', vector (vector (0, 0), vector (0, 1000000000)));
