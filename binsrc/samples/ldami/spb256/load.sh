...
cd /1s2/spb256
java -jar semantic_publishing_benchmark-basic-virtuoso.jar spb256gen.properties 
isql $PORT dba dba exec="ld_dir_all ('/1s2/spb256/generated', '*.nq*', 'ldbc')"
...
java -jar semantic_publishing_benchmark-basic-virtuoso.jar spb256qgen.properties 
