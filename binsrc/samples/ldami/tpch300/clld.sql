...
ld_dir ('/1s2/tpch300data', '%.tbl%', 'sql:tpch_cl_load (?)');

--cl_exec ('ld_dir (''/home/tpch100data'', ''%.tbl%'', ''sql:tpch_cl_load (?)'', txn => 0)', txn => 1, hosts => vector (1));
--cl_exec ('ld_dir (''/home/tpch100data'', ''%.tbl%'', ''sql:tpch_cl_load (?)'', txn => 0)', txn => 1, hosts => vector (3));
